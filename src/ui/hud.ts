 ...
 */
const LEGEND = [
  '<b>click</b> select  <b>shift</b> add / altitude  <b>1-9 tab</b> squadron  <b>a</b> all',
  '<b>right click</b> order  <b>h</b> hold  <b>z x c</b> tight open wide  <b>d</b> arm device',
  '<b>drag</b> orbit  <b>wheel</b> zoom  <b>middle drag</b> pan  <b>f</b> follow  <b>l</b> level  <b>g</b> gate down',
  '<b>space</b> hold time  <b>[ ]</b> slower faster',
].join('<br>')
